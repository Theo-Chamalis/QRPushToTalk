...
public abstract class AbstractCommentFragment extends DialogFragment {
     ...
     * This method is expected to set a callback that will call {@link com.terracom.mumbleclient.channel.comment.AbstractCommentFragment#loadComment(String comment)}.
